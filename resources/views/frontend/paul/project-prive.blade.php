            ...
            <div class="row">
                <div class="col-lg-4 left-menu">
                    <div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
                        <a href="{{ route('frontend.paul.projects') }}"><img src="{{ asset('images/paulmarc/projects/Marcs Website (Paul) components-10.png') }}" height="50" alt="header"/></a>
                    </div>
                </div>
                <div class="col-lg-4 middle-menu">
                    <div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
                        <img src="{{ asset('images/paulmarc/projects/Marcs Website (Paul) components-11.png') }}" height="40" alt="header"/>
                    </div>
                </div>
